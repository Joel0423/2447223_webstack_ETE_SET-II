...
make it a red or green border based on validation state */
...
const user_error_p = document.getElementById('username_error');
const email_error_p = document.getElementById('email_error');
const pass_error_p = document.getElementById('password_error');
const conf_pass_error_p = document.getElementById('conf_password_error');
const dob_error_p = document.getElementById('dob_error');
const gender_error_p = document.getElementById('gender_error');
const genre_error_p = document.getElementById('genre_error');
const country_error_p = document.getElementById('country_error');
const pic_error_p = document.getElementById('pic_error');
const bio_error_p = document.getElementById('bio_error');
...
const dob_error_msg = "Only 18 years or older can register on this website";
const gender_error_msg = "Select a gender";
const genre_error_msg = "Select at least 3 breeds of dogs";
const country_error_msg = "Select your country";
const pic_error_msg = "Upload a picture of your pet";
const bio_error_msg = "Enter a few lines for your pet's bio";
...
dob_inp.addEventListener('change', function () {
...
function submit_form() {
    ...
    else //there are invalid inputs put error border, icon and message on all those inputs
    {
